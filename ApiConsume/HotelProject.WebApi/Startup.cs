...
namespace HotelProject.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Bir api nin baþka kaynaklar tarafýndan consume(tüketilmesini) edilmesini saðlayan metot.
            ...
            //Newtonsoft.Json Ayarý, Eðer bir modelde döngüsel bir iliþki varsa bu yapýlandýrma bu döngüsel iliþkiyi görmezden gelir ve JSON çýktýsýnda bu tekrarlanan iliþkiyi önler.
