...
namespace HotelProject.WebUI.Controllers
{
    public class AdminFileController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(IFormFile file) //Dosya Yükleme İşlemi
        {
            var stream = new MemoryStream();  //Akışı Oluştur
            await file.CopyToAsync(stream); //Dosyayı ilgili yerden kopyala
