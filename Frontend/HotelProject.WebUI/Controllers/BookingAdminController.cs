...
namespace HotelProject.WebUI.Controllers
{
    public class BookingAdminController : Controller
    {
        ...
        public async Task<IActionResult> ApprovedReservation2(int id) //Rezervasyonu Onaylama
        {
            var client = _httpClientFactory.CreateClient();
        ...
        public async Task<IActionResult> CancelReservation(int id) //Rezervasyonu İptal Etme
        {
            var client = _httpClientFactory.CreateClient();
        ...
        public async Task<IActionResult> WaitReservation(int id) //Rezervasyonu Bekletme
        {
            var client = _httpClientFactory.CreateClient();
        ...
        [HttpGet] //Rezervasyon güncelleme işlemi için kullanıcı bilgilerini getirir.
        ...
        [HttpPost] //Rezervasyon güncellemesi yapar.
