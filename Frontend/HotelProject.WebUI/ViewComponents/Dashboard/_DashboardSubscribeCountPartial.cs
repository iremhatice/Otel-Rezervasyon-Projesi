    ...
    public class _DashboardSubscribeCountPartial : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://instagram-profile1.p.rapidapi.com/getprofile/iremhaticekarss"),
                Headers =
    {
        { "X-RapidAPI-Key", "5a9f1dbce5msh50a732a48b8da30p1d4f79jsn5f4fd933d041" },
        { "X-RapidAPI-Host", "instagram-profile1.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://twitter32.p.rapidapi.com/getProfile?username=iremhaticekars"),
                Headers =
    {
        { "X-RapidAPI-Key", "5a9f1dbce5msh50a732a48b8da30p1d4f79jsn5f4fd933d041" },
        { "X-RapidAPI-Host", "twitter32.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://fresh-linkedin-profile-data.p.rapidapi.com/get-linkedin-profile?linkedin_url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Firem-hatice-kars-2904b128a%2F&include_skills=false"),
                Headers =
    {
        { "X-RapidAPI-Key", "5a9f1dbce5msh50a732a48b8da30p1d4f79jsn5f4fd933d041" },
